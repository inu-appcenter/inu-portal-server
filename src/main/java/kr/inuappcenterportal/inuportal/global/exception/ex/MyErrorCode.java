...
public enum MyErrorCode {
    ...
    TIMETABLE_IMAGE_EMPTY_FILE(HttpStatus.BAD_REQUEST, "업로드된 시간표 이미지 파일이 비어 있습니다."),
    TIMETABLE_IMAGE_UNSUPPORTED_FILE(HttpStatus.BAD_REQUEST, "이미지 파일만 업로드할 수 있습니다."),
    TIMETABLE_IMAGE_RECOGNITION_FAILED(HttpStatus.BAD_GATEWAY, "이미지를 분석하지 못했습니다. 흐리거나 잘린 이미지, 혹은 지원하지 않는 학교의 시간표일 수 있어요. 다른 이미지로 다시 시도해 주세요."),
    TIMETABLE_IMAGE_RECOGNITION_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "이미지 분석 시간이 너무 오래 걸려 중단됐습니다. 잠시 후 다시 시도해 주세요."),
