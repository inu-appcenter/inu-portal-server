...
public enum MyErrorCode {
    ...
    NO_CUSTOM_ITEM_IN_TIMETABLE(HttpStatus.BAD_REQUEST, "해당 시간표에 속한 강의가 이닙니다."),
    NO_CUSTOM_ITEM(HttpStatus.BAD_REQUEST, "커스텀 시간표 요소가 아닙니다."),
    ...
    NECESSARY_DAT_OF_WEEK(HttpStatus.BAD_REQUEST, "요일을 필수입니다."),
