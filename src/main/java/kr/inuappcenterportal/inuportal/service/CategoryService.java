...
public class CategoryService {
    ...
    public Long addCategory(CategoryDto categoryDto){
        if(categoryRepository.existsByCategory(categoryDto.getCategory())){
            throw new MyDuplicateException(MyErrorCode.USER_DUPLICATE_CATEGORY);
        }
    ...
    public Long changeCategoryName(CategoryUpdateDto categoryUpdateDto){
        Category category = categoryRepository.findByCategory(categoryUpdateDto.getCategory()).orElseThrow(()->new MyNotFoundException(MyErrorCode.CATEGORY_NOT_FOUND));
    ...
    public void deleteCategory(String category){
        Category cate = categoryRepository.findByCategory(category).orElseThrow(()->new MyNotFoundException(MyErrorCode.CATEGORY_NOT_FOUND));
