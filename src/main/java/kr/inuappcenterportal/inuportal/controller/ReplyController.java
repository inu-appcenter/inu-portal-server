...
public class ReplyController {
    ...
    @PostMapping("/{postId}")
    public ResponseEntity<?> saveReply(@RequestHeader("Auth") String token, @RequestBody ReplyDto replyDto, @Parameter(name = "postId",description = "게시글의 id",in = ParameterIn.PATH)@PathVariable Long postId){
        log.info("댓글 등록 호출");
    ...
    @PutMapping("/{replyId}")
    public ResponseEntity<?> updateReply(@RequestHeader("Auth") String token, @RequestBody ReplyDto replyDto, @Parameter(name = "replyId",description = "댓글의 id",in = ParameterIn.PATH)@PathVariable Long replyId){
    ...
    public ResponseEntity<?> deleteReply(@RequestHeader("Auth") String token, @Parameter(name = "replyId",description = "댓글의 id",in = ParameterIn.PATH)@PathVariable Long replyId){
    ...
    public ResponseEntity<?> saveReReply(@RequestHeader("Auth") String token, @RequestBody ReplyDto replyDto, @Parameter(name = "replyId",description = "댓글의 id",in = ParameterIn.PATH)@PathVariable Long replyId){
        log.info("댓글 저장 호출");
        Long memberId = Long.parseLong(tokenProvider.getUsername(token));
    ...
    public ResponseEntity<?> likePost(@RequestHeader("Auth") String token, @Parameter(name = "replyId",description = "댓글의 id",in = ParameterIn.PATH)@PathVariable Long replyId){
