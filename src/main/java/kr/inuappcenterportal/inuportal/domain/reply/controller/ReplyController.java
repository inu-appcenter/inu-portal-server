package kr.inuappcenterportal.inuportal.domain.reply.controller;
...
public class ReplyController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201",description = "대댓글 등록 성공",content = @Content(schema = @Schema(implementation = ResponseDto.class)))
