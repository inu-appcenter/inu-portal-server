...
public interface KeywordRepository extends JpaRepository<Keyword, Long> {
    ...
    @Query("SELECT DISTINCT k.memberId FROM Keyword k " +
            ...
            "AND k.keywordCategory = :keywordCategory")
    List<Long> findMemberIdsByKeywordAndKeywordCategoryMatches(@Param("title") String title,
                                                               @Param("keywordCategory") KeywordCategory keywordCategory);
}
