...
public interface SuggestionApiSpecification {
    ...
    ResponseEntity<ResponseDto<Long>> saveSuggestion(
    ...
    ResponseEntity<ResponseDto<SuggestionListResponse>> getSuggestionList(
            @AuthenticationPrincipal Member member,
    ...
    ResponseEntity<ResponseDto<SuggestionResponse>> getSuggestion(
            @Parameter(name = "suggestionId", description = "건의사항의 id", in = ParameterIn.PATH) @PathVariable Long suggestionId,
            @AuthenticationPrincipal Member member
    );
    ...
    ResponseEntity<byte[]> getSuggestionImage(
            @Parameter(name = "suggestionId", description = "건의사항의 id", in = ParameterIn.PATH) @PathVariable Long suggestionId,
    ...
    ResponseEntity<ResponseDto<Long>> deleteSuggestion(
            @Parameter(name = "suggestionId", description = "건의사항의 id", in = ParameterIn.PATH) @PathVariable Long suggestionId,
            @AuthenticationPrincipal Member member
    );
    ...
    ResponseEntity<ResponseDto<Long>> changeSuggestionStatus(
            @Parameter(name = "suggestionId", description = "건의사항의 id", in = ParameterIn.PATH) @PathVariable Long suggestionId,
            @Valid @RequestBody SuggestionStatusRequest suggestionStatusRequest
    );
}
