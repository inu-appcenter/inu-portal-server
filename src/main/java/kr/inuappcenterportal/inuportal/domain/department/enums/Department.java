...
public enum Department {
    ...
    ELECTRONICS_ENGINEERING("전자공학과", College.COLLEGE_OF_ENGINEERING),
    ...
    BIO_ROBOTICS_ENGINEERING("바이오로봇시스템공학과", College.COLLEGE_OF_ENGINEERING),
    ...
    TECHNO_MANAGEMENT("계약학과", College.COLLEGE_OF_BUSINESS_ADMINISTRATION),
    ...
    CIVIL_ENVIRONMENT_ENGINEERING("도시환경학부 (건설환경공학전공)", College.COLLEGE_OF_URBAN_SCIENCE),
    ENVIRONMENT_ENGINEERING("도시환경학부 (환경공학전공)", College.COLLEGE_OF_URBAN_SCIENCE),
    URBAN_ENGINEERING("도시공학과", College.COLLEGE_OF_URBAN_SCIENCE),
    URBAN_ARCHITECTURE("도시건축학부", College.COLLEGE_OF_URBAN_SCIENCE),
    ...
    private final College collegeName;
}
