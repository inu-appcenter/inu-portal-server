...
public class CafeteriaController {
    ...
    @Operation(
            summary = "학식 메뉴 가져오기",
            description = "url 파라미터에 식당 이름(학생식당, 학생식당 1코너(백반), 학생식당 2코너(일품), 학생식당 국밥, 학생식당 4코너(일품), 학생식당 5코너(고급일품), 제1기숙사식당, 2기숙사 식당, 2호관(교직원)식당, 27호관식당, 사범대식당)과 요일(월요일 : 1 ~ 일요일 : 7)을 보내주세요. 학생식당은 1코너(백반)와 같고, 27호관식당은 요일 무관 상시 메뉴입니다. 응답은 [조식, 중식, 석식] 순이며 운영하지 않는 끼니는 \"-\" 입니다."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
