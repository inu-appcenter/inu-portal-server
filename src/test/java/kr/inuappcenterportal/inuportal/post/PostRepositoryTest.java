...
public class PostRepositoryTest {
    ...
    public void getPostListTest1(){
        ...
        List<Post> posts = postRepository.findFilteredPosts(null,null,null,null,pageable);
        assertAll(
    ...
    public void getPostListTest2(){
        ...
        post5.delete();
        Pageable pageable = PageRequest.of(0, 8, Sort.by(Sort.Direction.DESC, "id"));
        List<Post> posts = postRepository.findFilteredPosts("수강신청",null,List.of(post1.getId()),null,pageable);
        assertAll(
